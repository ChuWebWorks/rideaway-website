...
const AppStoreButtons = () => {
    return <>
        <a href='https://www.apple.com/app-store/' target='_blank' className='inline-block mx-2 md:px-0 md:mr-2inline-block mx-2 md:mx-0 md:mr-4 md:px-0 md:mr-2 md:ml-0 shadow-2xl md:ml-0 shadow-2xl'><img className='' src={AppleStoreImage} /></a>
